...
#
# This wrapper is referenced only when a clang-tidy-cache binary is on PATH;
# otherwise run-clang-tidy invokes the real clang-tidy directly and this file is
# never touched.
set -euo pipefail
